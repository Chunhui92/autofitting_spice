...
from calibration.project_paths import CALIBRATION_OUTPUT_DIR, DATASET_OUTPUT_DIR, DEFAULT_TARGET_CSV
...
def main_generate_dataset() -> int:
    ...
    args = parser.parse_args()
    from calibration.dataset_generator import main as generate_dataset
