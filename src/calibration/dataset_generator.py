...
def main(output_dir: str | Path | None = None) -> None:
    resolved_output_dir = OUTPUT_DIR if output_dir is None else Path(output_dir)
    param_csv_path = resolved_output_dir / "virtual_mosfet_params.csv"
    metric_csv_path = resolved_output_dir / "virtual_mosfet_metrics.csv"
    plot_w_path = resolved_output_dir / "metrics_vs_w.png"
    plot_l_path = resolved_output_dir / "metrics_vs_l.png"
